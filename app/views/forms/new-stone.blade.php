...
{{ Form::open(array('route' => 'store_stone', 'method' => 'POST')) }}

    <div class="form-group">
        {{ Form::label('stone_name', 'Stone Name' . ':') }}
        {{ Form::text('stone_name', null, array('class' => 'form-control')) }}
    </div>

    <div class="form-group">
        {{ Form::label('stone_description', 'Stone Description' . ':') }}
        {{ Form::text('stone_description', null, array('class' => 'form-control')) }}
    </div>
    ...
    <div class="form-group">
        ...
        {{ Form::label('stone_color_fireplace', 'Fireplace') }}
