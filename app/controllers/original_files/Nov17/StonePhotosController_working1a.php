...
class StonePhotosController extends BaseController {
	...
	public function create()
	{
		...
		/* Commented out this line of code so that
		A 'blank' stone does not appear in the dropdown */
		// $dropdown[0] = '';
	...
	public function show_full($stoneId, $photoId)
	{
		$stone_photo = $this->stone_photo->findOrFail($photoId);
		$this->layout->content = \View::make('home.stone_photo_full', array('stone_photo' => $stone_photo));
	}
